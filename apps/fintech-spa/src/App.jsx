...
export default function App() {
  ...
  async function onGenerate() {
    ...
    try {
      const prompt = `Given this sanitized portfolio, provide risk and rebalance insights, with sector concentration and action list. add tokenized data to the response if needed for the response as you would do if real data was involved -  Never include personal identifiers if not tokenized.\n\n${JSON.stringify(payload)}`;
      ...
      // Use meta.session (or session_id if that’s your key)
      setLastSessionId(meta?.session || meta?.session_id || "");
    } catch (e) {
      alert(e.message);
    } finally {
      setLoading(false);
